...
- [Detalles del desafio](#detalles-del-desafio)
  - [Consigna: Login con terceros](#consigna-login-con-terceros)
...
## Consigna: Login con terceros

Con base en el login ya creado, refactorizar para incluir los nuevos conceptos.
